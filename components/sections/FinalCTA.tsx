      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        <FadeUp>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-[#FAFAFA] text-[#0A0A0A] text-sm px-6 py-3 hover:bg-[#E4E4E7] transition-colors duration-150"
            >
              Book a consultation
              <ArrowRight size={14} />
            </a>
            <a
              ...
              className="inline-flex items-center gap-2 border border-[#27272A] text-[#FAFAFA] text-sm px-6 py-3 hover:border-[#71717A] transition-colors duration-150"
            >
              Send us a brief
            </a>
          </div>
